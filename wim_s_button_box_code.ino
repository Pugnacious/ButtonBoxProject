#include </home/pugnacious/Dropbox/ButtonBox Project/wim_s_button_box_code/src/Keypad.h>
#include </home/pugnacious/Dropbox/ButtonBox Project/wim_s_button_box_code/src/Joystick.h>

//DEFINITIONS
#define ENABLE_PULLUPS
#define NUMROTARIES 2 //replace "?" with number of rotary encoders you are using
#define NUMBUTTONS 14 //replace "?"with number of buttons you are using
...
rotariesdef rotaries[NUMROTARIES] {
  {0,1,28,29,0}, //rotary 1
  {2,3,30,31,0} //rotary 2
};
...
byte rowPins[NUMROWS] = {4,5,6}; //change "?" to the pins the rows of your button matrix are connected to
byte colPins[NUMCOLS] = {7,8,9,10,11}; //change "?" to the pins the rows of your button matrix are connected to
...
void CheckAllPotentiometers(){
  ...
  //zAxis_ = map(currentOutputLevel,-26515,-32580,0,255);
  //zAxis_ = constrain(rzAxis_,0,100);
  Joystick.setZAxis(zAxis_);
  //Joystick.setZAxis(constrain(zAxis_,0,100));
//  Serial.println(currentOutputLevel);
